...
(() => {
  ...
  function Demo() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { padding: 20 }, children: [
      dialogo,
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { id: "peligro", onClick: () => pedir({
        titulo: "\xBFBorrar el rol \xABSupervisor de patio\xBB?",
        dice: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
          "Esto ",
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { children: "no se puede deshacer" }),
          ". Quien tenga este rol se queda sin ninguno hasta que le asignes otro."
        ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { id: "normal", onClick: () => pedir({
        ...
        cancelar: "Seguir aqu\xED"
      }).then((r) => {
        window.ultimo = r;
      }), children: "normal" })
    ] });
  }
  (0, import_client.createRoot)(document.getElementById("r")).render(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Demo, {}));
})();
