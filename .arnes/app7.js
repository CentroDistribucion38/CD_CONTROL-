...
(() => {
  ...
  // src/modulos/quiebra/diario.ts
  var CAUSALES = [
    "Sorting distribuci\xF3n",
    "Presorting",
    "Rotura m\xE1quina",
    "Rotura dep\xF3sito",
    "Sorting envase",
  ...
  var NOMBRE_HOJA = {
    "Sorting distribuci\xF3n": "Rotura sorting",
    "Presorting": "Rotura pre sorting",
    "Rotura m\xE1quina": "Rotura m\xE1quina",
    "Rotura dep\xF3sito": "Rotura dep\xF3sito"
  };

  // src/app/(app)/quiebra/diario/Rejilla.tsx
  var import_jsx_runtime = __toESM(require_jsx_runtime());
  var MESES = ["ene", "feb", "mar", "abr", "may", "jun", "jul", "ago", "sep", "oct", "nov", "dic"];
  var nf = new Intl.NumberFormat("es-CO", { maximumFractionDigits: 0 });
  var pf = (v, d = 2) => v == null || !Number.isFinite(v) ? "\u2014" : (v * 100).toFixed(d).replace(".", ",") + "%";
  var dia = (f) => Number(f.slice(8, 10));
  var mesDe = (f) => MESES[Number(f.slice(5, 7)) - 1];
  function Rejilla({
    cols,
    editable,
    abierto,
    ...
    if (!cols.length) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "rj-vacio", children: "El per\xEDodo elegido no tiene d\xEDas." });
    }
    ...
    const causalTot = (cc) => cols.reduce((s, c) => s + (c.causalVale[cc] ?? 0), 0);
    const clase = (c) => c.fecha === abierto ? " aqui" : "";
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "rj-marco", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { className: "rj", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "rot", children: "Concepto" }),
        cols.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "num" + clase(c), children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "button",
          {
            type: "button",
            onClick: () => abrir(c.fecha),
            title: `${dia(c.fecha)} de ${mesDe(c.fecha)}`,
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: dia(c.fecha) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: mesDe(c.fecha) })
            ]
          }
        ) }, c.fecha)),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "num total", children: "Total" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tbody", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { className: "calc", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "rot", children: "META" }),
          cols.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "num" + clase(c), children: pf(c.meta) }, c.fecha)),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "num total", children: "\u2014" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "rot", children: "Producci\xF3n" }),
          cols.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            Casilla,
            {
              extra: clase(c),
              ...
              etiqueta: `Producci\xF3n del ${dia(c.fecha)} de ${mesDe(c.fecha)}`
            },
            c.fecha
          )),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "num total", children: prodTot ? nf.format(prodTot) : "\u2014" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", { className: "rot", children: [
            "Baja",
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                type: "button",
                className: "rj-mas",
                onClick: alternarDesglose,
                "aria-expanded": mostrarDesglose,
                children: mostrarDesglose ? "\u2212 ocultar causales" : "+ por causal"
              }
            )
          ] }),
          cols.map((c) => c.hayDesglose ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "td",
            {
              className: "num sumado" + clase(c),
              title: "Este d\xEDa tiene el desglose por causal escrito: el total es su suma.",
              children: nf.format(c.baja)
            },
            c.fecha
          ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            Casilla,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "num total", children: bajaTot ? nf.format(bajaTot) : "\u2014" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { className: "calc pct", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "rot", children: "% Quiebra" }),
          cols.map((c) => {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "num total", children: pf(pctTot) })
        ] }),
        mostrarDesglose && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { className: "rj-sep", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", { className: "rot", colSpan: cols.length + 2, children: [
            "Desglose por causal",
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { children: "Escribir aqu\xED manda sobre el total: la fila Baja pasa a ser esta suma. Dejar todas en blanco devuelve el d\xEDa al total escrito, y si tampoco hay, a lo de SAP." })
          ] }) }),
          CAUSALES.map((cc) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { className: "rj-causal", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", { className: "rot", children: [
              NOMBRE_HOJA[cc] ?? cc,
              NOMBRE_HOJA[cc] && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { children: cc })
            ] }),
            cols.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              Casilla,
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "num total", children: causalTot(cc) ? nf.format(causalTot(cc)) : "\u2014" })
          ] }, cc))
        ] })
      ] })
    ] }) });
  ...
  function Casilla({ valor, sap, vale, editable, cambiar, etiqueta, extra }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "cel" + extra + (escrito ? " tocada" : "") + (difiere ? " difiere" : ""), children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "input",
      {
        inputMode: "decimal",
        value: valor,
        ...
        "aria-label": etiqueta,
        title: difiere && sap != null ? `SAP dice ${nf.format(sap)}` : void 0
      }
    ) });
  }
  ...
  var dias = (n) => Array.from({ length: n }, (_, i) => {
    const f = `2026-08-${String(i + 1).padStart(2, "0")}`;
    const prod = 38e3 + i * 7919 % 9e3;
    ...
    const bajaEf = desglose ? CAUSALES.reduce((s, cc) => s + (causalVale[cc] ?? 0), 0) : baja;
    return {
      fecha: f,
      produccion: prod,
      baja: bajaEf,
      pct: bajaEf / prod,
      meta: 0.0135,
      sapProduccion: prod - 120,
      sapBaja: baja + 15,
      produccionEsc: String(prod),
      bajaEsc: desglose ? "" : String(baja),
      causalesEsc,
      hayDesglose: desglose,
      causalVale
    };
  });
  function Arnes() {
    const [abierto, setAbierto] = (0, import_react.useState)("2026-08-12");
    const [desglose, setDesglose] = (0, import_react.useState)(true);
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "qb qd", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "tarjeta", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "cab", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { children: "Quiebra diaria" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: "Agosto de 2026 \u2014 CD38" })
      ] }) }),
  ...
  (0, import_client.createRoot)(document.getElementById("r")).render(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Arnes, {}));
})();
