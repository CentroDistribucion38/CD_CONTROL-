...
(() => {
  ...
  // src/components/ClaveProvisional.tsx
  ...
  __iconData2.node;
  var Eye = createLucideIcon(__iconData2);

  // src/components/ClaveProvisional.tsx
  var import_jsx_runtime = __toESM(require_jsx_runtime());
  function ClaveProvisional({ id, nombre }) {
    const router = useRouter();
    const [nueva, setNueva] = (0, import_react4.useState)("");
    const [rep, setRep] = (0, import_react4.useState)("");
    const [ver, setVer] = (0, import_react4.useState)(false);
    const [trabajando, setTrabajando] = (0, import_react4.useState)(false);
    const [mal, setMal] = (0, import_react4.useState)(null);
    const reglas = [
      { t: "M\xEDnimo 8 caracteres", ok: nueva.length >= 8 },
      { t: "Una may\xFAscula", ok: /[A-ZÁÉÍÓÚÑ]/.test(nueva) },
      { t: "Un n\xFAmero", ok: /\d/.test(nueva) }
    ];
    ...
    async function cambiar() {
      ...
      if (/^\d+$/.test(nueva)) return setMal("No puede ser solo n\xFAmeros.");
      setTrabajando(true);
      ...
      const { error: e2 } = await supabase.from("perfiles").update({ clave_provisional: false }).eq("id", id);
      setTrabajando(false);
      if (e2) return setMal(e2.message);
      router.refresh();
    }
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cp", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "cp-caja", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cp-ojo", children: "PRIMER INGRESO" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", { children: [
        "Cambia tu clave, ",
        nombre.split(" ")[0]
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "cp-dice", children: [
        "La que te dieron son cuatro d\xEDgitos y sirvi\xF3 para entrar una vez. Elige una tuya y sigues. ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Nadie m\xE1s la ve, ni el administrador." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cp-campos", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Clave nueva" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cp-caja-clave", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                ...
                children: ver ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeOff, { size: 17 }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { size: 17 })
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Rep\xEDtela" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "input",
            {
              type: ver ? "text" : "password",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "cp-reglas", children: reglas.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { className: nueva && r.ok ? "ok" : "", children: r.t }, r.t)) }),
      mal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cp-mal", role: "alert", children: mal }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          type: "button",
          ...
          children: trabajando ? "Guardando\u2026" : "Cambiar y entrar"
        }
      )
    ] }) });
  }
  ...
  var root = (0, import_client2.createRoot)(document.getElementById("r"));
  root.render(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ClaveProvisional, { id: "u1", nombre: "G\xE9nesis Visbal" }));
})();
