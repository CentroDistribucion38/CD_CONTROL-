...
/**
 * VALIDACIÓN — la tercera y última firma, la que deja salir el camión.
 *
 ...
 * y eso lo impone la tabla, no esta pantalla.
 */
    ...
    <div className="rt">
      <section className="cabeza">
        <div>
          ...
          <p className="sub">
            Salidas ya verificadas, esperando el aval para que el camión salga. Es la última
