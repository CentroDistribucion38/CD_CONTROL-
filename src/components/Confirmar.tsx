 ...
 *     return (<>{dialogo}...</>)
 *
 * ESTO PREGUNTA SÍ O NO, y nada más. Hubo una versión con un campo de
 * texto adentro —para el motivo de una revisión AI— y se quitó al día
 * siguiente: el motivo no hacía falta, y un campo opcional que nadie
 * llena es un paso de más en el muelle. Si alguna vez hace falta
 * escribir algo para decidir, va en su propio cuadro y no aquí: este
 * pone el foco en CANCELAR y deja que Enter cancele, y eso deja de ser
 * cierto en cuanto hay un campo donde escribir.
 *
